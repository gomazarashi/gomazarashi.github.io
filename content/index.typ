...
#html.div(class: "link-panel-group")[
  #html.div(class: "link-panel")[
    ...
    #html.ul(class: "panel-list")[
      #html.li[#link("/posts/first-post/")[最初の記事]]
      #html.li[#link("/posts/example-second-post/")[二本目の記事の仮リンク]]
      #html.li[#link("/posts/example-third-post/")[三本目の記事の仮リンク]]
    ]
  ]
]
...
#html.div(class: "link-panel-group")[
  #html.div(class: "link-panel")[
    ...
    #html.ul(class: "panel-list")[
      #html.li[#link("https://example.com/qiita")[Qiita]]
      #html.li[#link("https://example.com/oucrc")[OUCRC.net]]
    ]
  ]
  ...
  #html.div(class: "link-panel")[
    ...
    #html.ul(class: "panel-list")[
      #html.li[#link("https://example.com/external-article-1")[代表記事 1]]
      #html.li[#link("https://example.com/external-article-2")[代表記事 2]]
    ]
  ]
]
